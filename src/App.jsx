/**
 * ============================================================================
 * ENTERPRISE SCADA & LOGIC IDE
 * Features: Fixed Dropdown Overflow, Grid Controls, UI Enhancements
 * ============================================================================
 */
...
export default function App() {
  ...
  const writeTag = useCallback((tagName, value) => {
    setTags(prev => ({ ...prev, [tagName]: { ...prev[tagName], value } }));
  }, []);

  const addCustomTag = useCallback((key, type, val) => {
    setTags(prev => ({ ...prev, [key]: { type, value: val } }));
  }, []);
